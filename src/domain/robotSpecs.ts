...
export const NXT_BASE = {
  ...
  width: 0.17,
  wheelRadius: 0.041,
  /** Лінійна швидкість руху по лінії на тренувальному столі, м/с */
  speed: 0.09,
} as const;

/**
 * Замкнена лінія на тренувальному столі в нормованих локальних координатах
 * (центр поля — (0,0), край поля = ±1). Ті самі точки використовуються
 * і для друку лінії на текстурі поверхні, і для сплайна руху робота.
 */
export const FIELD_TRACK: Array<[number, number]> = [
